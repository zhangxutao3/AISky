...
COMMON_LAYERS = (
    ...
    LayerSpec("u2m", "U2M", "2 米纬向风", "m/s", ("U2M",), (-20.0, 20.0), tuple(PALETTES["pressure"])),
    LayerSpec("v2m", "V2M", "2 米经向风", "m/s", ("V2M",), (-20.0, 20.0), tuple(PALETTES["pressure"])),
    LayerSpec("u10m", "U10M", "10 米纬向风", "m/s", ("U10M",), (-20.0, 20.0), tuple(PALETTES["pressure"])),
    LayerSpec("v10m", "V10M", "10 米经向风", "m/s", ("V10M",), (-20.0, 20.0), tuple(PALETTES["pressure"])),
    LayerSpec("u50m", "U50M", "50 米纬向风", "m/s", ("U50M",), (-20.0, 20.0), tuple(PALETTES["pressure"])),
    LayerSpec("v50m", "V50M", "50 米经向风", "m/s", ("V50M",), (-20.0, 20.0), tuple(PALETTES["pressure"])),
    LayerSpec(
        "wind10",
        "WIND10",
        "10 米风速",
    ...
    LayerSpec("dufluxu", "DUFLUXU", "沙尘东西向质量通量", "g/(m·s)", ("DUFLUXU",), (-1.0, 1.0), tuple(PALETTES["pressure"]), scale=1000.0),
    LayerSpec("dufluxv", "DUFLUXV", "沙尘南北向质量通量", "g/(m·s)", ("DUFLUXV",), (-1.0, 1.0), tuple(PALETTES["pressure"]), scale=1000.0),
    LayerSpec("dudp", "DUDP", "沙尘干沉降", "ng/(m²·s)", ("DUDP",), (0.0, 500.0), tuple(PALETTES["dust"]), scale=1_000_000_000_000.0),
    LayerSpec("duem", "DUEM", "沙尘排放", "ng/(m²·s)", ("DUEM",), (0.0, 1000.0), tuple(PALETTES["dust"]), scale=1_000_000_000_000.0),
    LayerSpec("duwt", "DUWT", "沙尘湿沉降", "ng/(m²·s)", ("DUWT",), (0.0, 1000.0), tuple(PALETTES["dust"]), scale=1_000_000_000_000.0),
